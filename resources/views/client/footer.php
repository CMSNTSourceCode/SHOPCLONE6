        ...
        <div class="row">
            <div class="col-lg-6">
                <ul class="list-inline mb-0">
                    <li class="list-inline-item"><a
                            href="<?=BASE_URL('client/chinh-sach-bao-mat');?>"><?=__('Chính sách bảo mật');?></a></li>
                    <li class="list-inline-item"><a
                            href="<?=BASE_URL('client/dieu-khoan-su-dung');?>"><?=__('Điều khoản sử dụng');?></a></li>
                </ul>
            </div>
            <div class="col-lg-6 text-right">
                <span class="mr-1">
                    ...
                    <?=__('Version');?> <b
                        style="color: red;"><?=$config['version'];?></b> | Powered By <a target="_blank" href="https://www.cmsnt.co/?ref=<?=base_url();?>">CMSNT.CO</a>
                </span>
            </div>
        </div>
    </div>
...
setInterval(function() {
    $('#giftbox').load('<?=base_url('ajaxs/client/loadGiftBox.php');?>');
}, 5000);
</script>
