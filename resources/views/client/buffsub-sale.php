...
$body = [
    'title' => __('Buff Sub Sale').' | '.$CMSNT->site('title'),
                        ...
                        <div class="card-body p-0">
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-lg-6 mb-5">
                                    <a type="button" href="<?=base_url('client/buffsub-sale-history');?>" class="btn btn-outline-primary btn-block mt-2"><i
                                ...
                                <div class="col-sm-12 col-lg-12">
                                    ...
                                    <div class="form-group row align-items-center" id="form_loaiseeding">
                                        ...
                                        <div class="col-sm-8">
                                            <?php foreach($CMSNT->get_list("SELECT * FROM `rate_autofb` WHERE `type_api` = 'buffsub_sale' AND `price` > 0 ") as $row):?>
