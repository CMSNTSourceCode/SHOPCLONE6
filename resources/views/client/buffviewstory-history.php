...
$body = [
    'title'     => __('Lịch sử order buff view story').' | '.$CMSNT->site('title'),
                    ...
                    <div class="card-header ">
                        <div class="row">
                            <div class="col-sm-12 col-lg-6">
                                <a type="button" href="<?=base_url('client/buffviewstory');?>"
                    ...
                    <div class="card-body p-0">
                        <div class="table-responsive">
                            <table class="table data-table table-hover mb-0">
                                ...
                                <tbody>
                                    <?php $i=0; foreach ($CMSNT->get_list("SELECT * FROM `order_autofb` WHERE `type` = 'buffviewstory' AND `user_id` = '".$getUser['id']."' ORDER BY id DESC LIMIT 1000  ") as $row) {?>
                                    <tr>
                                        <td><?=$i++;?></td>
                                        <td><?=$row['trans_id'];?></td>
                                        <td><a target="_blank" href="https://www.facebook.com/stories/<?=$row['uid'];?>"><?=$row['uid'];?></a></td>
