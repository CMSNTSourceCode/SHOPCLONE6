...
if (isset($_GET['id'])) {
    ...
    if (!$row) {
        redirect(base_url('admin/question-list'));
    }
} else {
    redirect(base_url('admin/question-list'));
}
...
if (isset($_POST['SaveQuestion'])) {
    ...
    $isInsert = $CMSNT->update("questions", [
    ...
    if ($isInsert) {
        ...
        $CMSNT->insert("logs", [
            ...
            'createdate'    => gettime(),
            'action'        => "Chỉnh sửa câu hỏi ID (".$row['id'].")."
        ]);
...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Chỉnh sửa câu hỏi</h1>
                </div>
                <div class="col-sm-6">
                        ...
                        <form action="" method="POST">
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="question"><?=$row['question'];?></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Câu trả lời</label>
                                    <textarea class="form-control" name="answer"><?=$row['answer'];?></textarea>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="card-footer clearfix">
                                <button name="SaveQuestion" class="btn btn-info btn-icon-left m-b-10" type="submit"><i
