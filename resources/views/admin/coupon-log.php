...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Nhật ký sử dụng coupon</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?=BASE_URL('admin/');?>">Dashboard</a></li>
                        <li class="breadcrumb-item active">Nhật ký sử dụng coupon</li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive p-0">
                                <table id="datatable1" class="table table-striped table-bordered text-center">
                                    ...
                                    <tbody>
                                        <?php $i=0;
                                        foreach ($CMSNT->get_list("SELECT * FROM `coupon_used` WHERE `coupon_id` = '".$row['id']."' ") as $log) {?>
                                        <tr>
                                            <td><?=$i++;?></td>
                                            <td><b><?=$row['code'];?></b></td>
                                            <td><a
                                                    href="<?=base_url('admin/user-edit/'.$log['user_id']);?>"><?=getUser($log['user_id'], 'username');?></a>
                                            </td>
                                            <td><span style="font-size: 15px;"
                                                    class="badge badge-info"><?=$log['trans_id'];?></span>
                                            </td>
