...
if (isset($_POST['AddQuestion'])) {
    ...
    $isInsert = $CMSNT->insert("questions", [
    ...
    if ($isInsert) {
        ...
        $CMSNT->insert("logs", [
            ...
            'createdate'    => gettime(),
            'action'        => "Thêm câu hỏi FAQ vào hệ thống."
        ]);
        die('<script type="text/javascript">if(!alert("Thêm thành công !")){location.href = "'.BASE_URL('admin/question-list').'";}</script>');
    } else {
...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Thêm câu hỏi & câu trả lời</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?=BASE_URL('admin/');?>">Dashboard</a></li>
                        <li class="breadcrumb-item active">Thêm câu hỏi & câu trả lời</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <section class="col-lg-6">
                    <div class="mb-3">
                        <a class="btn btn-danger btn-icon-left m-b-10" href="<?=base_url('admin/question-list');?>"
                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <form action="" method="POST">
                            ...
                            <div class="card-footer clearfix">
                                <button name="AddQuestion" class="btn btn-info btn-icon-left m-b-10" type="submit"><i
