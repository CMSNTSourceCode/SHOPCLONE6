...
$body = [
    'title' => 'Chỉnh sửa chuyên mục tài liệu',
    'desc'   => 'CMSNT Panel',
...
if (isset($_GET['id'])) {
    ...
    if (!$row) {
        redirect(base_url('admin/category-document-list'));
    }
} else {
    redirect(base_url('admin/category-document-list'));
}
...
if (isset($_POST['SaveCategory'])) {
    ...
    if (check_img('image') == true) {
        ...
        if ($addlogo) {
            $CMSNT->update("document_categories", [
                'image' => $uploads_dir
            ], " `id` = '".$row['id']."' ");
        }
    }
    $isUpdate = $CMSNT->update("document_categories", [
    ...
    if ($isUpdate) {
        ...
        $CMSNT->insert("logs", [
            ...
            'createdate'    => gettime(),
            'action'        => "Chỉnh sửa chuyên mục tài liệu (".$row['name']." ID ".$row['id'].")."
        ]);
...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Chỉnh sửa chuyên mục tài liệu</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?=BASE_URL('admin/');?>">Dashboard</a></li>
                        <li class="breadcrumb-item active">Chỉnh sửa chuyên mục tài liệu</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-footer clearfix">
                                <button name="SaveCategory" class="btn btn-info btn-icon-left m-b-10" type="submit"><i
