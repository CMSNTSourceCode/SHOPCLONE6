...
if (isset($_POST['AddCategory'])) {
    ...
    if ($isInsert) {
        ...
        die('<script type="text/javascript">if(!alert("Thêm thành công !")){location.href = "'.BASE_URL('admin/category-list').'";}</script>');
    } else {
        ...
        <div class="container-fluid">
            <div class="row">
                <section class="col-lg-6">
                    <div class="mb-3">
                        <a class="btn btn-danger btn-icon-left m-b-10" href="<?=base_url('admin/category-list');?>"
